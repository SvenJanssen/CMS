...
@section('breadcrumb')
	{{ Breadcrumbs::render('delete_page') }}
@stop
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">
			<h1>Verwijder Route <small>van selecteerde website: <b><u> <?php echo Session::get('database') ?> </u></b></small></h1>
		</h3>
	</div>
	<div class="panel-body">
		<table class="table table-striped">
			...
			<tr>
				<td>
					{{ $websiteRoute->firstname }}
				</td>
				<td>
					{{ Form::open(array('route' => 'deleteRoute.post', 'role' => 'form')) }}
						{{ Form::hidden('websiteRouteId', $websiteRoute->id) }}
						{{ HTML::decode(Form::button('<span class="glyphicon glyphicon-trash pull-right"></span><strong>Verwijder </strong> ', array('type' => 'submit',  'class' => 'btn btn-danger pull-right'))) }}
					{{ Form::close() }}
				</td>
			</tr>
			@endforeach
...
@section('js')
	<script type="text/javascript">
		...
		$("#deletePageButton").addClass("active");
